...
from MinkowskiNet.lib.pc_utils import Camera, read_plyfile
from MinkowskiNet.lib.dataset import DictDataset, VoxelizationDataset, TemporalVoxelizationDataset, \
    str2datasetphase_type, DatasetPhase
from MinkowskiNet.lib.transforms import cfl_collate_fn_factory
from MinkowskiNet.lib.utils import read_txt, debug_on
...
class TestSynthia(unittest.TestCase):
  ...
  def test(self):
    ...
    from MinkowskiNet.lib.utils import Timer
