...
class ConvType(Enum):
  ...
  SPATIAL_HYPER_CUBE_TEMPORAL_HYPERCROSS = 6, 'SPATIAL_HYPER_CUBE_TEMPORAL_HYPERCROSS '
...
conv_to_region_type = {
    ...
    ConvType.SPATIAL_HYPER_CUBE_TEMPORAL_HYPERCROSS: ME.RegionType.CUSTOM
}
...
def convert_conv_type(conv_type, kernel_size, D):
  ...
  if conv_type == ConvType.SPATIAL_HYPER_CUBE:
    ...
    # conv_type conversion already handled
    assert D == 4
  elif conv_type == ConvType.SPATIAL_HYPER_CUBE_TEMPORAL_HYPERCROSS:
